/*
  ...
  ImageMagick API methods prefix.
...
#define IInterpolateColor  PrependMagickMethod(IInterpolateColor)
...
#define MogrifyImageInfo  PrependMagickMethod(MogrifyImageInfo)
...
#define SyncCache  PrependMagickMethod(SyncCache)
